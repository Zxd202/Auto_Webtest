...
class Login_Page_Locator(object):
    ...
    def __init__(self):
        ...
        self.username = (By.XPATH, '//*[@id="app"]/div/div/form/div[1]/div/div[1]/input')
        self.password = (By.XPATH, '//*[@id="app"]/div/div/form/div[2]/div/div/input')
        self.submit = (By.XPATH,'//*[@id="app"]/div/div/form/div[3]/div/button[1]/span')
